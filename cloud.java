...
class TrainingImageManager {
    ...
    */
    ...
    private static CloudBlobContainer getContainer() throws Exception {
        ...
        CloudBlobContainer container = blobClient.getContainerReference("training-images");
...
class TrainingAudioManager {
    ...
    */
    ...
    private static CloudBlobContainer getContainer() throws Exception {
        ...
        // Get a reference to a container.
        // The container name must be lower case
        CloudBlobContainer container = blobClient.getContainerReference("training-audios");
    ...
    public static String UploadAudio(InputStream audio, int audioLength) throws Exception {
        ...
        String audioName = randomString(10) + ".mp3";
    ...
    public static String[] ListAudios() throws Exception {
        CloudBlobContainer container = getContainer();
